...
#define STRING_CONFIG_H_AUTHOR "THE_KILLER" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2556.2,94.4962144}  // default steps per unit for Ultimaker
